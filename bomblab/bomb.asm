...
0000000000400ee0 <phase_1>:
  400ee0:	48 83 ec 08          	sub    $0x8,%rsp # 栈指针必须在函数调用之前对齐到16字节边界
...
0000000000400efc <phase_2>:
  ...
  400f05:	e8 52 05 00 00       	call   40145c <read_six_numbers> # 从%rdi中读取abcdef六个整数
...
0000000000400f43 <phase_3>:
  ...
  400f75:	ff 24 c5 70 24 40 00 	jmp    *0x402470(,%rax,8) # 跳转到地址0x402470 + %eax*8处
...
0000000000400fce <func4>: # 初始值%edi = a, %esi = 0, %edx = 0xe
